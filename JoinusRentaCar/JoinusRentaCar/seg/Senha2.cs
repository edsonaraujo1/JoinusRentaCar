...
namespace WindowsFormsApplication1
{
    public partial class Senha2 : Form
    {
        ...
        private void Senha1_Load(object sender, EventArgs e)
        {
            ...
            string host = "EDSON-PC\\SQLEXPRESS_2";
            string usuario = "sa";
            string senha = "12345";
            ...
            string strSQL = "SELECT * FROM [DB_ALUGUEL].[dbo].[TB_USUARIOS_CLIENTES] ORDER BY ID_USUARIO_CLIENTE";
            ...
            try
            {
                ...
                try
                {
                    ...
                    while (dr.Read())
                    {
                        this.textBox1.Text = dr["ID_USUARIO_CLIENTE"].ToString();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            string strSQL = "SELECT * FROM [DB_ALUGUEL].[dbo].[TB_USUARIOS_CLIENTES] ORDER BY ID_USUARIO_CLIENTE DESC";
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            string strSQL = "SELECT * FROM [DB_ALUGUEL].[dbo].[TB_USUARIOS_CLIENTES] ORDER BY ID_USUARIO_CLIENTE ASC";
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            string strSQL = "SELECT * FROM [DB_ALUGUEL].[dbo].[TB_USUARIOS_CLIENTES] WHERE ID_USUARIO_CLIENTE = " + seek + "";
            SqlConnection conexao = new SqlConnection("Data Source=" + host + ";DATABASE=" + banco + ";UID=" + usuario + "; PWD=" + senha + ";");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string strSQLupd = "UPDATE TB_USUARIOS_CLIENTES SET   SITUACAO = " + SITUACAO + "," +
                                                            "USUARIO = '" + USUARIO + "'," +
                                                            "SENHA = '" + SENHA + "' WHERE ID_USUARIO_CLIENTE = " + seek_up + "";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string host = "EDSON-PC\\SQLEXPRESS_2";  // "EDSON-PC\\SQLEXPRESS_2";
            string usuario = "sa";
            string senha = "12345";
            string banco = "DB_ALUGUEL";
            //string id_busca = " ";
            ...
            string strSQL = "SELECT * FROM [DB_ALUGUEL].[dbo].[TB_USUARIOS_CLIENTES] WHERE ID_USUARIO_CLIENTE = " + seek_c + "";
